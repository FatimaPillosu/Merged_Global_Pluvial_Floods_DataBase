...
switch NameRawDB
    ...
    case 'EMDAT'
        ...
        DataLine = 3;
        Delimiter = ",";
        NameVars = ["Start date","End date","Country","ISO","Location","Latitude","Longitude","Magnitude value","Magnitude scale","Disaster type","Disaster subtype","Associated disaster","Associated disaster2","Total deaths","Total affected","Total damage ('000 US$)","Insured losses ('000 US$)","Disaster name","Disaster No."];
        TypeVars = ["string", "string", "string", "string",	"string", "double",	"double", "double",	"string", "string", "string", "string", "string", "double", "double", "double",	"double", "string",	"string"];
     case 'ESWD'
        NumVars = 97;
        DataLine = 2;
        Delimiter = ",";
        NameVars = ["ID","QC_LEVEL","INFO_SOURCE","CONTACT","EMAIL","ORGANISATION","ORGANISATION_ID","NO_REVISION","PERSON_REVISION","TIME_EVENT","TIME_CREATION","TIME_LAST_REVISION","TIME_ACCURACY","COUNTRY","STATE","PLACE","PLACE_LOCAL_LANGUAGE","DETAILED_LOCATION","NEAREST_CITY","LATITUDE","LONGITUDE","PLACE_ACCURACY","OROGRAPHY","SURFACE_INITIAL_LOCATION","SURFACE_CROSSED","TYPE_EVENT","NO_OBJECTS","MAX_HAIL_DIAMETER","MAX_HAILSTONE_WEIGHT","AVERAGE_HAIL_DIAMETER","THICKNESS_HAIL_LAYER","HAILSTONE","F_SCALE","T_SCALE","RATING_BASIS","WIND_SPEED","TEN_MIN_WIND_SPEED","FUNNEL_SIGHTED","SUCTION_VORTICES","PRECIPITATION_AMOUNT","SNOW_FALL_AMOUNT","PEAK_PRECIP_AMOUNT","PEAK_SNOW_FALL_AMOUNT","PEAK_PRECIP_PERIOD","MAX_6_HOUR_PRECIP","MAX_6_HOUR_SNOW_FALL","MAX_12_HOUR_PRECIP","MAX_12_HOUR_SNOW_FALL","MAX_24_HOUR_PRECIP","MAX_24_HOUR_SNOW_FALL","CONVECTIVE","TOTAL_DURATION","TYPE_PRECIP","SIZE_ACCOMPANYING_HAIL","POSSIBILITIES","PATH_LENGTH","MEAN_PATH_WIDTH","MAX_PATH_WIDTH","MAX_VERTICAL_DEVELOP","DIRECTION_MOVEMENT","SNOW_HAZARDS","MEAN_HEIGHT_SNOW_CORNICES","MAX_HEIGHT_SNOW_CORNICES","ICE_HAZARDS","THICKNESS_ICE_COVER","THICKNESS_RIME_COVER","AVALANCHE_TYPE","AVALANCHE_FLOW_TYPE","SNOW_MASS_TYPE","AVALANCHE_SIZE","AVALANCHE_TRIGGER","ELEVATION_START","ELEVATION_DIFFERENCE","LIGHTNING_DAMAGE_TO","PEAK_CURRENT","POLARITY","EXCEPT_ELEC_PHENOM","PROPERTY_DAMAGE","CROP_FOREST_DAMAGE","TOTAL_DAMAGE","NO_INJURE","NO_KILLED","EVENT_DESCRIPTION","PATH_START_LATITUDE","PATH_START_LONGITUDE","PATH_START_DATETIME","PATH_END_LATITUDE","PATH_END_LONGITUDE","PATH_END_DATETIME","EXT_URL","REFERENCE","IMPACTS","CREATOR_ID","REVISOR_ID","LINK_ORG","LINK_ID","DELETED"];
        TypeVars = ["double", "string",	"string", "string",	"string", "string", "string", "double", "string", "string",	"string", "string",	"string", "string", "string", "string",	"string", "string",	"string", "double",	"double", "string",	"string", "string", "string", "string",	"string", "double", "double", "double", "double", "double",	"double", "double", "double", "double", "double", "double", "double", "double", "double", "double",	"double", "double", "double", "double",	"double", "double",	"double", "double",	"string", "double", "double", "double", "double", "double", "double", "double", "double", "double",	"double", "double", "double", "double",	"double", "double", "double", "double", "double", "double",	"double", "double", "double", "double",	"double", "double", "double", "string", "string", "string", "double", "double",	"string", "string",	"string", "string",	"string", "string",	"string", "string", "string", "string", "string", "string",	"string", "double",	"string"];
     case 'SED'
        NumVars = 51;
        DataLine = 2;
        Delimiter = ",";
        NameVars = ["BEGIN_YEARMONTH","BEGIN_DAY","BEGIN_TIME","END_YEARMONTH","END_DAY","END_TIME","EPISODE_ID","EVENT_ID","STATE","STATE_FIPS","YEAR","MONTH_NAME","EVENT_TYPE","CZ_TYPE","CZ_FIPS","CZ_NAME","WFO","BEGIN_DATE_TIME","CZ_TIMEZONE","END_DATE_TIME","INJURIES_DIRECT","INJURIES_INDIRECT","DEATHS_DIRECT","DEATHS_INDIRECT","DAMAGE_PROPERTY","DAMAGE_CROPS","SOURCE","MAGNITUDE","MAGNITUDE_TYPE","FLOOD_CAUSE","CATEGORY","TOR_F_SCALE","TOR_LENGTH","TOR_WIDTH","TOR_OTHER_WFO","TOR_OTHER_CZ_STATE","TOR_OTHER_CZ_FIPS","TOR_OTHER_CZ_NAME","BEGIN_RANGE","BEGIN_AZIMUTH","BEGIN_LOCATION","END_RANGE","END_AZIMUTH","END_LOCATION","BEGIN_LAT","BEGIN_LON","END_LAT","END_LON","EPISODE_NARRATIVE","EVENT_NARRATIVE","DATA_SOURCE"];
        TypeVars = ["string","string","string","string","string","string","double","double","string","double","double","string","string","string","double","string","string","string","string","string","double","double","double","double","string","string","string","double","string","string","string","string","double","double","string","string","double","string","double","string","string","double","string","string","double","double","double","double","string","string","string"];
    otherwise
...
if m < 3
    ...
    for j = 3 : m
        ...
        TotRawDB_temp = [TotRawDB_temp; load_RawFL(RawDB_File_temp, NumVars, DataLine, Delimiter, NameVars, TypeVars)];
    end
end
